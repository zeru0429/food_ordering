...
<div class="main">
    ...
    <form action="#" method="post" enctype='multipart/form-data'>
        <table class="halfwidth">
            ...
            <tr>
                <td>Description</td>
               <td> <textarea name="description" value="<?php echo $description; ?>"  id="description" cols="30" rows="10"> <?php echo $description; ?> </textarea></td>
            </tr>
            <tr>
                <td>price</td>
            ...
            <?php
                if(!isset($imagename)){
                    ...
                    ?> 
                    <td>
                 <img src="../images/food/<?php echo $imagename; ?>" alt="" width="50vh"></td>
                 <?php } ?>
            </tr>
            ...
            <tr>
                <td colspan="2"><input type="submit" name="updatefood" value="updatefood" class="btn-sec"></td>
            </tr>
        </table>
        </form>
        <?php
...
if(isset($_POST['updatefood'])){
    ...
    $query ="UPDATE food SET title ='$title', description='$description', price='$price', image_name='$image_name', category_id ='$catagory_id', featured='$feature', active='$active' WHERE id='$id'";
    $result = mysqli_query($conn,$query)or die(mysqli_error());
    $result = mysqli_query($conn,$query) or die(mysqli_error());
    if($result == True){
